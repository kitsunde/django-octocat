...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Repository.homepage'
        db.alter_column(u'github_repository', 'homepage', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Repository.homepage'
        raise RuntimeError("Cannot reverse this migration. 'Repository.homepage' and its values cannot be restored.")
